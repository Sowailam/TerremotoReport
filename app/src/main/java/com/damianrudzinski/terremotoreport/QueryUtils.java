...
/**
 * Created by damianrudzinski on 02.05.2017.
 */
...
public final class QueryUtils {
    ...
    private static final String CANDY_JSON = "{\"features\":[\"properties\":{\"mag\":\"6.1\",\"name\":\"Jelly Beans\",\"count\":12140}]}";
    ...
    public static ArrayList<Earthquake> extractEarthquakes() {
        ...
        JSONObject root;
        JSONArray features;
        JSONObject earthquakeEntry;
        JSONObject properties;
        try {
            root = new JSONObject(SAMPLE_JSON_RESPONSE);
            features = root.getJSONArray("features");
            for (int i=0; i<root.length(); i++) {
                earthquakeEntry = features.getJSONObject(i);
                properties = earthquakeEntry.getJSONObject("properties");
            ...
            Log.e("QueryUtils", earthquakes.toString());
